"""
Script para consultar la API del Banco Mundial y guardar datos del PIB Real (crecimiento anual %).
"""
...
# Configuración
INDICADOR_CODIGO = 'NY.GDP.MKTP.KD.ZG'  # GDP growth (annual %)
INDICADOR_NOMBRE = 'Variación del PIB Real (anual %)'
INDICADOR_DESCRIPCION = 'El estándar de oro. Mide el crecimiento de la producción descontando el efecto de la inflación.'
INDICADOR_UNIDAD = '%'
...
def procesar_y_guardar_datos():
    """Procesa y guarda los datos del PIB Real en la base de datos."""
    print("🚀 Iniciando ingesta de datos del PIB Real...")
